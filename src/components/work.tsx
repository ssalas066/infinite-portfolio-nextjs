...
const Work = () => {
    return (
        ...
        <div className=" flex min-h-screen flex-col py-5 mb-4">
            <div className=" mb-10">
                <div className=" grid grid-cols-2 mx-auto mt-5 mb-10 max-w-7xl px-6 lg:px-2">
                    ...
                    <div className=" col-span-1 bg-gray-600 max-w-sm rounded-md mb-5 overflow-hidden shadow-lg">
